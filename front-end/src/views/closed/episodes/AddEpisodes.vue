  ...
  <div class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
    <div class="bg-gradient-to-br from-gray-900/95 to-black rounded-2xl shadow-2xl border border-red-600/30 w-full max-w-sm p-6 text-sm">
      ...
      <div class="flex justify-between items-center mb-4 border-b border-red-600/30 pb-2">
        <h2 class="text-lg font-semibold text-white">Add Episode</h2>
      ...
      <form @submit.prevent="submitForm" class="space-y-4">
        ...
        <!-- Season -->
        <div>
          <label class="block mb-1 text-sm font-medium text-gray-300">Season</label>
        ...
        <!-- Episode Number -->
        <div>
          <label class="block mb-1 text-sm font-medium text-gray-300">Episode Number</label>
        ...
        <!-- Video Upload -->
        <div>
          <label class="block mb-1 text-sm font-medium text-gray-300">Upload Video</label>
          <input
            type="file"
            accept="video/*"
            @change="handleFile"
