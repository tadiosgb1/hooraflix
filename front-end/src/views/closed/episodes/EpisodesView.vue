  ...
  <div class="p-6 bg-black min-h-screen text-sm text-white relative">
    ...
    <div class="hidden md:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      <div v-for="(item, index) in items" :key="item.id"
        class="bg-gradient-to-br from-gray-900/50 to-black border border-gray-700/50 rounded-xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition duration-200 p-4 flex flex-col justify-between">
