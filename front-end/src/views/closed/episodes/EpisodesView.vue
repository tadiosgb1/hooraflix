        ...
        <table class="min-w-full text-sm divide-y divide-gray-200">
          <thead class="bg-gray-100 text-gray-700 uppercase text-xs font-semibold">
            <tr>
              ...
              <th class="px-6 py-3 text-left">Season_id</th><th class="px-6 py-3 text-left">Title</th><th class="px-6 py-3 text-left">Episode_number</th><th class="px-6 py-3 text-left">Duration</th><th class="px-6 py-3 text-left">Video_url</th>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="(item, index) in items" :key="item.id" class="hover:bg-green-50 transition duration-150">
              ...
              <td class="px-6 py-4 whitespace-nowrap">{{ item.season_id }}</td><td class="px-6 py-4 whitespace-nowrap">{{ item.title }}</td><td class="px-6 py-4 whitespace-nowrap">{{ item.episode_number }}</td><td class="px-6 py-4 whitespace-nowrap">{{ item.duration }}</td><td class="px-6 py-4 whitespace-nowrap">{{ item.video_url }}</td>
      ...
      <div v-for="(item, index) in items" :key="item.id" class="bg-white border border-gray-200 rounded-xl shadow p-4">
        ...
        <div class="grid grid-cols-2 gap-y-1 text-sm text-gray-700">
            ...
            <div class="col-span-2">
              <span class="font-medium text-gray-600">Season_id:</span>
              {{ item.season_id }}
            </div>
            <div class="col-span-2">
            ...
            <div class="col-span-2">
              <span class="font-medium text-gray-600">Episode_number:</span>
              {{ item.episode_number }}
            </div>
            <div class="col-span-2">
