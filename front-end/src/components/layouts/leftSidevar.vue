    ...
    return {
      ...
      menuItems: [
       ...
       
        {
          ...
          icon: "fas fa-users",
          children: [
            { name: "Users", route: "Users-view", permission: "" },
            { name: "Roles", route: "Role-view", permission: "" },
            { name: "Permissions", route: "Permission-view", permission: "" }
          ]
        },

        {
          ...
          icon: "fas fa-folder",
          children: [
            { name: "Categories", route: "Categories-view", permission: "" },
